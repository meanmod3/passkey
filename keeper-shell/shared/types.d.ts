...
export type AuditAction = 'REQUEST_CREATED' | 'REQUEST_APPROVED' | 'REQUEST_DENIED' | 'LEASE_STARTED' | 'SHARE_ISSUED' | 'RENEWAL_PROMPTED' | 'RENEWAL_REQUESTED' | 'EXTENSION_APPROVED' | 'EXTENSION_DENIED' | 'LEASE_RELEASED' | 'LEASE_EXPIRED' | 'RECORD_LOCKED' | 'RECORD_UNLOCKED';
